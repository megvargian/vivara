...
$founder_profiles = get_field('profiles') ?: array(
    array('name' => 'Charbel Semaan', 'bio' => '', 'photo' => 'Charbel%20Semaan.jpeg'),
    array('name' => 'Fabienne Semaan', 'bio' => '', 'photo' => 'Fabienne%20Semaan.jpeg'),
    array('name' => 'Joy Semaan', 'bio' => 'Lawyer', 'photo' => 'Joy-Semaan-lawyer.jpeg'),
    array('name' => 'Maria Malek', 'bio' => 'Senior Design Consultant', 'photo' => 'Maria%20Malek%20%2C%20Senior%20Design%20Consultant.jpeg'),
    array('name' => 'Pamela Semaan', 'bio' => 'Medical Doctor', 'photo' => 'Pamela%20Semaan%20%2C%20Medical%20Doctor.jpeg'),
    array('name' => 'Richard Semaan', 'bio' => 'Senior Architect', 'photo' => 'Richard-Semaan-Senior-Architect.jpeg'),
);
...
<section class="founders" id="founders">
  ...
  <h2 class="big-title reveal"><?php echo esc_html($title); ?></h2>
  ...
  <div class="founders-grid">
    ...
    <article class="founder-profile reveal reveal-delay-<?php echo $index; ?>">
      <div class="founder-photo">
        <img src="<?php echo esc_url($image_base_url . $profile['photo']); ?>" alt="<?php echo esc_attr($profile['name']); ?>">
      </div>
